...
# A=int(input("Enter the oldest people no.:"))
# B=int(input("Enter the youngest people no.:"))
# if A>B:
#     print("youngest")
# else:
#     print("oldest")
...
if num>40 and num<70:
    print(num,"in range of 40 to 70")
if num1>70 and num1<80:
    print(num1,"in range of 70 to 80")
else:
    print("not in range")